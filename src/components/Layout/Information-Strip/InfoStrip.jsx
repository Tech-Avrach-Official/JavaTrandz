...
export default function InfoStrip() {
    ...
    return (
        <div className={`info-strip bg-black flex items-center justify-between pr-5 md:px-7 ${strip ? '' : 'hidden'}`}>
            <div></div>
            <div>
                <AnimatedGradientText>
                    ...
                    <span
                        className={cn(`
inline animate-gradient bg-gradient-to-r from-[#ffaa40] via-[#40ffdc] to-[#ffaa40] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent text-xs lg:text-sm
`)}
                    >
