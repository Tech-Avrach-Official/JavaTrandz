                    ...
                    <div className='w-full md:w-[35%] gap-0.5 md:gap-2 p-1 md:p-5 flex md:flex-col'>
                        {courseData.map((course) => (
                            <div
                                ...
                                className='bg-black border border-black h-14 w-1/2 md:w-full md:full md:h-24 rounded-sm md:rounded-md lg:px-8 flex items-center justify-center md:justify-normal cursor-pointer'
                            >
                                <div className='flex justify-center items-center gap-7'>
                                    <FontAwesomeIcon icon={course.icon} className='text-white text-3xl lg:text-6xl' />
                                    <p className='hidden md:block text-2xl font-medium text-white'>{course.name}</p>
                                </div>
                            </div>
